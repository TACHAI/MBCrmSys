...
public class ConsumerController {
    ...
    @ResponseBody
    public ServerResponse<Consumer> login(String name, String password, HttpSession session){
        ServerResponse<Consumer> response=iConsumerService.login(name,password);
