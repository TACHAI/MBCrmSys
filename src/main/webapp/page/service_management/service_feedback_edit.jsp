...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row border-bottom white-bg">
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-collapse collapse" id="navbar">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li>
                        <a href="<%=request.getContextPath() %>/queryFeedback.doServe">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <br>
            <form class="form-horizontal" action="<%=request.getContextPath() %>/editFeedbackEdit.doServe" method="post">
                <div class="form-group col-sm-6">
                    <label for="ser_result" class="col-sm-4 control-label">处理结果：</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" name="ser_result" id="ser_result"/>
                    </div>
                </div>
                <div class="form-group col-sm-6">
                    <label for="ser_satisfcing" class="col-sm-4 control-label">满意度：</label>
                    <div class="col-sm-4">
                        <select class="form-control" name="ser_satisfcing" id="ser_satisfcing">
