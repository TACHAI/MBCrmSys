...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
           <form role="form" class="form-horizontal" name="form1" action="<%=request.getContextPath() %>/queryArchive.doServe" method="post">
                <div class="row">
			...
			<%
				...
				if(serves != null){
					...
					for(Serve serve : serves){
						switch(serve.getSerState().intValue()) {
						case 1: state="已创建"; 
								break;  
						case 2: state="已分配";
								break;
			...
			%>
						<tr>
		                    ...
		                    <td><%=state %></td>
							<td><a href="editArchiveList.doServe?id=<%=serve.getSerId() %>">查看明细</a></td>
						</tr>
			<% 
					}
				}
...
function page(pageNum,pageCount){
	...
	document.form1.action="queryArchive.doServe?page="+pageNum;
	$("#submit").click();
}
</script>