    ...
    <div class="row border-bottom white-bg">
        <nav class="navbar navbar-static-top" role="navigation">
            <div class="navbar-header">
                ...
                <a href="" class="navbar-brand">客户流失分析</a>
            </div>
           ...
           <form role="form" class="form-horizontal" name="form1" action="<%=request.getContextPath() %>/queryCusContribution.doServe" method="post">
                <div class="row">
                   <div class="form-group col-sm-6">
                       <label for="cus_name" class="col-sm-4 control-label">客户名称：</label>
                       <div class="col-sm-8">
                           <input type="text" name="cus_name" class="form-control" id="cus_name"/>
                       </div>
                   </div>
                   <div class="form-group col-sm-6">
                       <label for="los_manager" class="col-sm-4 control-label">客户经理：</label>
                       <div class="col-sm-8">
                           <input type="text" name="los_manager" class="form-control" id="los_manager"/>
                       </div>
                   </div>
                </div>
