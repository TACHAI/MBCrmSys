...
<body class="gray-bg top-navigation">
	<% Assort assort=(Assort)request.getAttribute("assort") ; %>
	<div id="wrapper">
						...
						<div class="col-lg-12">
							<div class="ibox float-e-margins">
								...
								<div class="ibox-content">
									<form  class="form-horizontal" action="assortlist?flag=save&id=<%=assort.getAssId() %>&cus_id=<%=assort.getCustomer().getCusId() %>" name="form1" method="post">
										<div class="ibox-content">
											...
											<div class="form-group col-sm-6">
												...
												<div class="col-sm-8">
													<input type="date" class="form-control"
														value="<%=assort.getAssDate() %>" id="atv_date"
														name="atvDate" />
												</div>
											</div>
											<div class="form-group col-sm-6">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control"
														value="<%=assort.getAssPalce() %>" id="atv_place"
														name="atvPlace" />
											...
											<div class="form-group col-sm-6">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control"
														value="<%=assort.getAssResume() %>" id="atv_title"
														name="atvTitle" />
												</div>
											</div>
											<div class="form-group col-sm-6">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control"
														value="<%=assort.getAssMemo() %>" id="lkm_tel"
														name="memo" />
												</div>
											</div>
											...
											<div class="form-group ">
												...
												<div class="col-sm-6">
													<textarea rows="5" class="form-control" id="atv_desc"
														name="detail"><%=assort.getAssDetail() %></textarea>
												</div>
											</div>
