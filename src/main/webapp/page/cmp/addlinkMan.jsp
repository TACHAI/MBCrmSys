                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <form role="form" class="form-horizontal" action="<%=request.getContextPath() %>/linkmanlist?flag=add&cusId=<%=request.getParameter("cusId") %>" method="post">
                                        <div class="ibox-content">

                                            <div class="form-group ">
                                                <label for="lkm_name" class="col-sm-2 control-label">姓名：</label>
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" id="lkm_name" name="lkmName"/>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="lkm_postion" name="lkmPostion"/>
                                                </div>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label for="lkm_tel" class="col-sm-4 control-label">办公电话：</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="lkm_tel" name="lkmTel"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="lkm_mobile" name="lkmMobile"/>
                                                </div>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label for="lkm_memo" class="col-sm-4 control-label">备注：</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="lkm_memo" name="lkmMemo"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
