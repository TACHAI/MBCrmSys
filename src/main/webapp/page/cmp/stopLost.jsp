...
<body class="gray-bg top-navigation">
 <% Lost lost=(Lost)request.getAttribute("lost"); %>
    <div id="wrapper">
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <form role="form" class="form-horizontal" action="lostlist?flag=save" name="form1" method="post">
                                        <div class="ibox-content">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-6">
                                                    <textarea rows="5" class="form-control" id="lst_delay" name="LostRespite()" readonly="readonly"><%=lost.getLosRespite() %></textarea>
                                                </div>
                                            </div>

                                            <div class="form-group ">
                                                <label for="atv_desc" class="col-sm-2 control-label">追加暂缓措施：</label>
                                                <div class="col-sm-6">
                                                    <textarea rows="5" class="form-control"  id="atv_desc" name="losRespite" ></textarea>
                                                </div>
                                            </div>
