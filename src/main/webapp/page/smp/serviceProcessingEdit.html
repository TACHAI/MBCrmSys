<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.rlg.crm.domain.Serve,java.sql.Timestamp" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row border-bottom white-bg">
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-collapse collapse" id="navbar">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li>
                        <a href="<%=request.getContextPath() %>/queryProcessing.doServe">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <br>
            <form class="form-horizontal" action="<%=request.getContextPath() %>/editServe.doServe" method="post">
                <div class="form-group">
                    <label for="ser_handle" class="col-sm-2 control-label">服务处理：</label>
                    <div class="col-sm-9">
                    	<textarea style="resize: none" name="ser_handle" value="" class="form-control" rows="3" id="ser_request" placeholder="服务处理"></textarea>
                    </div>  
                </div>
                <div class="form-group col-sm-6">
                    <label for="ser_handle_name" class="col-sm-4 control-label">处理人：</label>
                    <div class="col-sm-7">
                        <input type="text" value="火鸣佐樱" name="ser_handle_name" class="form-control" id="ser_handle_name"/>
                    </div>
		       </div>

                <div class="form-group col-sm-6">
                    <label for="ser_handle_date" class="col-sm-4 control-label">处理时间：</label>
                    <div class="col-sm-7">
                        <input type="text" value="<%=new Timestamp(System.currentTimeMillis()) %>" name="ser_handle_date" class="form-control" id="ser_handle_date"/>
                    </div>
                </div>
                <input type="submit" style="display:none;" id="submit"/>
                <input type="hidden" name="id" value="<%=serve.getSerId() %>"/>
                <br><br><br>
            </form>
        </div>
    </div>
...
$(function(){
	$("#save").click(function() {
        ...
        else if($("#ser_handle_name").val() == ""){
           alert("处理人不能为空！");
            return false;
        }
        else if($("#ser_handle_date").val() == ""){
        	alert("处理时间不能为空！");
            return false;
        }
        $("#submit").click();   
