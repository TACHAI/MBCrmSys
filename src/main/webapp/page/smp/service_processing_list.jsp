	...
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				<form role="form" class="form-horizontal" name="form1" action="<%=request.getContextPath() %>/queryProcessing.doServe" method="post">
                <div class="row">
			...
			%>
						<tr>
							...
							<td><a href=" edit.doServe?id=<%=serve.getSerId() %>">处理</a></td>
						</tr>
			<% 
					}
				}
...
function page(pageNum,pageCount){
	...
	document.form1.action="queryProcessing.doServe?page="+pageNum;
	$("#submit").click();
}
</script>